    ...
    return (
        <section class="timeline">
            <div class="title-wrapper">
                ...
                <h3 class="h3">Experiência de Trabalho</h3>
            </div>
            <ol class="timeline-list">
                <li class="timeline-item">
                    <h4 class="h4 timeline-item-title">Desenvolvedor Frontend Junior em <b className="title-business">Spot Metrics</b></h4>
                    <span>2021 — 2022</span>
            ...
            <ol class="timeline-list">
                <li class="timeline-item">
                    <h4 class="h4 timeline-item-title">Web Developer em <b className="title-business">OFM Systems</b></h4>
                    <span>2021 — 2021</span>
                    <p class="timeline-text">
            ...
            <ol class="timeline-list">
                <li class="timeline-item">
                    <h4 class="h4 timeline-item-title">Programador Jr em <b className="title-business">ID5 Soluções</b></h4>
                    <span>2020 — 2021</span>
                    <p class="timeline-text">
            ...
            <ol class="timeline-list">
                <li class="timeline-item">
                    <h4 class="h4 timeline-item-title">Estágiario  em <b className="title-business">Equatorial Energia</b></h4>
                    <span>2019 — 2020</span>
                    <p class="timeline-text">
            ...
            <ol class="timeline-list">
                <li class="timeline-item">
                    <h4 class="h4 timeline-item-title">Web Designer <b className="title-business">FAN - Faculdade de Administração e Negócios</b></h4>
                    <span>2018 — 2019</span>
                    <p class="timeline-text">
